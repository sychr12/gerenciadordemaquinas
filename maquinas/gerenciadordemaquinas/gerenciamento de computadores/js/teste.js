document.addEventListener('DOMContentLoaded', function() {
    ...
    window.pesquisar = function() {
        ...
        const filtro = document.getElementById('vinidobubumguloso').value.toLowerCase(); // garantir consistência
        ...
        const resultados = computers.filter(computer => {
            ...
            const matchFiltro = filtro ? model.includes(filtro) : true;
    ...
    computerForm.appendChild(cancelButton);
});